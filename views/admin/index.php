...
<div class="panel-body">
    ...
    <?= $form->field($model, 'downloadData')->checkbox(['disabled' => !Yii::$app->hasModule('rest')])->hint(Yii::t('LegalModule.base', 'To enable data download, please enable the REST API module.')); ?>
